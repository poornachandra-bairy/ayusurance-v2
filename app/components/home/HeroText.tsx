  ...
  >
    <h1
      ...
      style={{
        ...
        background: 'linear-gradient(145deg, #2b4230 0%, #5f7750 42%, #a8843e 100%)',
    ...
    <div className="flex gap-4 flex-wrap">
      <button className="inline-block px-7 py-3 rounded-xl text-[0.9375rem] font-medium text-white bg-gradient-to-br from-[#b8934c] to-[#6c875b] shadow-[0_10px_28px_rgba(168,132,62,0.22)] transition-[transform,box-shadow] duration-300 hover:-translate-y-0.5 hover:shadow-[0_14px_34px_rgba(168,132,62,0.28)]">
        {HOME_HERO_CTA_PRIMARY}
      </button>
