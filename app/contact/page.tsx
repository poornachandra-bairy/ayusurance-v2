    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div
              className={`kinetic-text ${cormorant.className}`}
              style={{
            ...
            >
              Connect With Us — Connect With Us — Connect With Us — Connect With
              Us — Connect With Us — Connect With Us — Connect With Us — Connect
              With Us — Connect With Us — Connect With Us — Connect With Us —
              Connect With Us —
            </div>
          </div> */}

          <div
            className='sub-headline-wrapper'
            style={{
              width: '100%',
              textAlign: 'center',
              willChange: 'transform',
        ...
        >
          ...
          >
            <div
              className='contact-divider contact-line'
              style={{
                position: 'absolute',
                left: '50%',
                top: '-10%',
            ...
            <div
              className='reveal-block contact-grid-item'
            ...
            <div
              className='reveal-block contact-grid-item contact-phone-block'
                ...
                <div style={{ display: 'inline-block' }}>
                  <a
                    ...
                    style={{
                      ...
                      border: '1px solid',
                      borderColor: isPhoneHovered
                        ? '#1A1A1A'
                        : 'rgba(74, 99, 90, 0.4)',
                      borderRadius: '50%',
                      textDecoration: 'none',
                      transition:
                        'background 0.4s, border-color 0.4s, transform 0.2s',
                      cursor: 'pointer',
        ...
        <section
          style={{ position: 'relative', zIndex: 10, paddingBottom: '15vh' }}
        >
