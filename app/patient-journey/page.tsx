...
const SHEETS = [
  ...
  },
  {
    frontType: 'step',
    backType: 'step',
    frontData: JOURNEY_STEPS[0],
    backData: JOURNEY_STEPS[1],
  },
  {
    frontType: 'step',
    backType: 'step',
    frontData: JOURNEY_STEPS[2],
    backData: JOURNEY_STEPS[3],
  },
  {
    frontType: 'step',
    backType: 'step',
    frontData: JOURNEY_STEPS[4],
    backData: JOURNEY_STEPS[5],
  },
  {
    frontType: 'step',
    backType: 'step',
    frontData: JOURNEY_STEPS[6],
    backData: JOURNEY_STEPS[7],
  },
  {
...
export default function PatientJourneyPage() {
  ...
  const outroP = clamp(
    (scrollProgress - INTRO_UNITS - FLIPS) / OUTRO_UNITS,
    0,
    1,
  );
  ...
  if (scrollProgress <= INTRO_UNITS) {
    baseScale = lerp(
      INITIAL_BOOK_SCALE,
      FULL_BOOK_SCALE,
      ease(ph(scrollProgress, 0, INTRO_UNITS)),
    );
      ...
      >
        <div className='sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden pt-[76px]'>
          ...
          >
            ...
            <h1
              className='font-display text-[clamp(2.4rem,5vw,4.2rem)] text-[#3b4a38] leading-[1.0] mb-4'
              style={{ fontWeight: 400 }}
            >
              Your Path to Wellness
            </h1>
            <p className='text-[#556353] font-body text-sm md:text-base leading-relaxed max-w-[38ch] mx-auto'>
              A transparent, seamless clinical process combining authentic
              Ayurvedic protocols with modern convenience.
            </p>
          </div>
          ...
          >
            ...
            <h2
              className='font-display text-[clamp(2.4rem,5vw,4rem)] text-[#3b4a38] leading-tight mb-4'
              style={{ fontWeight: 400 }}
            >
              A Restored Balance
            </h2>
            <p className='text-[#556353] font-body text-sm md:text-base leading-relaxed max-w-[38ch] mx-auto'>
              You have reached the end of the initial clinical protocol. True
              wellness is a continuous commitment — and we remain by your side.
            </p>
          </div>
          ...
          >
            ...
            {SHEETS.map((sheet, idx) => {
              ...
              const shadowStyle = isCoverSheet
                ? 'shadow-[2px_12px_25px_rgba(0,0,0,0.4)]'
                : 'shadow-[1px_4px_10px_rgba(0,0,0,0.12)]';
              ...
              return (
                ...
                >
                  ...
                  >
                    <RenderPage
                      type={sheet.frontType}
                      data={sheet.frontData}
                      side='right'
                    />
                  </div>
          ...
          >
            ...
            <div className='flex flex-col items-center text-[#2b4230] animate-bounce mt-1'>
              <svg
                className='w-6 h-6 md:w-8 md:h-8 -mb-4 opacity-70'
                fill='none'
                stroke='currentColor'
                strokeWidth='3'
                viewBox='0 0 24 24'
          ...
          >
            <div className='flex flex-col items-center text-[#2b4230] animate-bounce mb-1'>
              ...
              <svg
                className='w-6 h-6 md:w-8 md:h-8 -mt-4 opacity-70'
                fill='none'
                stroke='currentColor'
                strokeWidth='3'
                viewBox='0 0 24 24'
...
function RenderPage({
  ...
  const paperTexture = {
    ...
    boxShadow: isLeft
      ? 'inset -30px 0 50px rgba(0,0,0,0.06)'
      : 'inset 30px 0 50px rgba(0,0,0,0.06)',
  };
  ...
  if (type === 'cover') {
    return (
      <div
        className='w-full h-full flex flex-col items-center justify-center p-8 md:p-16 text-center bg-[#2b4230] relative border-l border-black/20'
      ...
      >
        ...
        <h2 className='text-[10px] md:text-sm font-sans tracking-[0.4em] text-[#a9bc97] uppercase mb-4'>
          {data.title}
        </h2>
        <h1 className='text-5xl md:text-7xl font-display font-medium text-[#f8f4ea] drop-shadow-lg mb-6 max-w-[12ch]'>
          {data.subtitle}
        </h1>
        <p className='text-[#a9bc97] italic font-serif text-sm md:text-lg'>
          {data.desc}
        </p>
      </div>
    );
  ...
  if (type === 'backcover') {
    return (
      <div
        className='w-full h-full flex flex-col items-center justify-center p-8 md:p-16 text-center bg-[#2b4230] relative border-r border-black/20'
        style={{ boxShadow: 'inset 0 0 100px rgba(0,0,0,0.5)' }}
      >
        <div className='absolute top-0 bottom-0 right-[2%] w-4 journey-shadow-side -scale-x-100' />
        <div className='absolute inset-4 md:inset-8 border-2 border-[#a8843e]/40 rounded-lg pointer-events-none' />
        <h1 className='text-4xl md:text-5xl font-display font-medium text-[#f8f4ea] mb-6 drop-shadow-md'>
          {data.title}
        </h1>
        <p className='text-[#a9bc97] font-body text-sm md:text-lg max-w-[30ch] mb-12'>
          {data.desc}
        </p>
  ...
  if (type === 'inside-cover') {
    return (
      <div
        className='w-full h-full flex flex-col items-center justify-center p-8 md:p-12 text-center'
        style={paperTexture}
      >
        ...
        <p className='text-[10px] md:text-xs tracking-[0.2em] uppercase text-[#7e966c] mb-6'>
          {SHLOKAS[0].attr}
        </p>
        <p className='text-[#556353] font-body text-sm md:text-base max-w-[40ch] leading-relaxed italic border-t border-black/10 pt-4 px-4'>
          "Ayurveda is that which deals with good, bad, happy and unhappy life,
    ...
    return (
      ...
      >
        ...
        <p className='text-[#556353] font-body text-sm md:text-base max-w-[44ch] leading-relaxed italic border-t border-black/10 pt-4 px-4'>
          "One whose doshas are balanced, whose appetite is good, whose tissues
          are functioning normally, whose wastes are eliminated properly, and
          whose self, mind, and senses remain full of bliss is called a healthy
          person."
        </p>
      </div>
    );
  ...
  return (
    ...
    >
      ...
      <div className='relative z-10 w-full pt-16 md:pt-32 px-4 md:px-12'>
        <h4
          className='text-[0.65rem] md:text-xs tracking-[0.2em] font-semibold uppercase mb-4 md:mb-6 drop-shadow-sm'
      ...
      <div
        className='mt-auto w-24 md:w-40 h-1'
        style={{ background: `${step.accentColor}50` }}
      />
    </div>
  );
}
